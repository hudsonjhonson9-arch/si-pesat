...
<div className="bg-pastel-cream/50 border border-dark-gray/15 rounded-xl px-3 py-2 shadow-xs text-center h-full flex flex-col justify-center">
              ...
              <p className="text-[12px] md:text-base font-black text-dark-gray underline underline-offset-2 decoration-dark-gray/20 leading-tight">{orgData.inspektur.nama}</p>
...
<div className="bg-pastel-blue/20 rounded-xl px-3 py-2 border border-dark-gray/15 shadow-xs text-center h-full flex flex-col justify-center">
              ...
              <p className="text-[12px] md:text-base font-black text-dark underline underline-offset-2 decoration-dark-gray/20 leading-tight">{orgData.sekretaris.nama}</p>
...
<div className="bg-pastel-lavender/20 rounded-xl px-3 py-2 border border-dark-gray/12 shadow-xs text-center h-full flex flex-col justify-center">
              ...
              <p className="text-[11px] md:text-base font-bold text-dark underline underline-offset-2 decoration-dark-gray/20 leading-tight">{orgData.analis.nama}</p>
...
<div className="bg-pastel-green/20 rounded-xl px-3 py-2 border border-dark-gray/12 shadow-xs text-center h-full flex flex-col justify-center">
              ...
              <p className="text-[11px] md:text-base font-bold text-dark underline underline-offset-2 decoration-dark-gray/20 leading-tight">{orgData.kasubag.nama}</p>
...
<div className="rounded-xl px-2.5 py-1.5 border border-dark-gray/12 shadow-xs text-center h-full flex flex-col justify-center" style={{ backgroundColor: ['#FFF0F0', '#FFF5E0', '#F0FFF0', '#F0F5FF', '#F5F0FF'][i] }}>
                  <p className="text-[8px] md:text-sm font-bold uppercase tracking-wider text-dark-gray/50 mb-0.5 leading-tight">{irban.wilayah}</p>
                  <p className="text-[9px] md:text-sm font-bold text-dark underline underline-offset-2 decoration-dark-gray/20 leading-tight">{irban.nama}</p>
