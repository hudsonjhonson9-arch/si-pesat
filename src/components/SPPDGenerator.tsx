...
export default function SPPDGenerator({ audit, activeCategory, userProfiles = [], onClose }: SPPDGeneratorProps) {
  ...
  const htmlContent = useMemo(() => {
    ...
    return `<div id="pdf-content" style="background: white;">${pages}</div>`;
          ...
          <div className="w-full md:w-1/2 bg-slate-200/50 flex flex-col p-4">
            ...
            <div className="mt-4 flex items-center justify-end gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-purple-600 text-white font-black text-xs rounded-xl shadow-lg shadow-purple-600/30 hover:bg-purple-700 transition-all active:scale-95 disabled:opacity-50"
              >
                {isGeneratingPdf ? (
